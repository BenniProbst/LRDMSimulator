...
import org.lrdm.topologies.strategies.LineTopologyStrategy;
 ...
 *
 */
public class ExampleSimulationLine {
	public static void main(String[] args) {
		...
		effector.setStrategy(new LineTopologyStrategy(), 40);
		effector.setStrategy(new FullyConnectedTopology(), 60);
		effector.setStrategy(new LineTopologyStrategy(), 80);
