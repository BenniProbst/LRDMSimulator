...
import org.lrdm.topologies.strategies.TreeTopologyStrategy;
 ...
 *
 */
public class ExampleSimulationTree {
	public static void main(String[] args) {
		...
		effector.setStrategy(new TreeTopologyStrategy(), 40);
		effector.setStrategy(new FullyConnectedTopology(), 60);
		effector.setStrategy(new TreeTopologyStrategy(), 80);
